...
const navigation = [
  ...
  { name: 'My Works', href: '/mywork', current: false },
...
export default function Header() {
  return (
    <Disclosure as="nav" className=" bg-gray-800" >
      {({ open }) => (
        <>
          <div className=" max-w-7xl mx-auto px-2 sm:px-6 lg:px-8" style={{ position: "sticky" }}>
            <div className="relative flex items-center justify-between h-16">
              ...
              <div className="flex-1 flex items-center justify-center sm:items-stretch sm:justify-start">
                <div className="flex-shrink-0 flex items-center">
                  <a className=' text-teal-400  text-3xl' style={{ fontFamily: 'Cedarville Cursive', }}>Art By Mariya</a>
                </div>
              ...
              <div className="absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
                ...
                ><a href="https://www.instagram.com/ummemariya00/">
